                    ...
                    <div class="item-bd">
                      ...
                      <div class="div-item">
                        ...
                        <ul class="section-content">
                          ...
                          <li>
                            主导整个项目正常开发流程，研究K线渲染组件TradingView的使用与原理
                          </li>
                        </ul>
                      </div>
                    </div>
          ...
          <div class="item">
            ...
            <div class="item-bd">
              <ul class="section-content">
                ...
                <li>
                  熟练使用Hibernate JPA，了解 MyBatis、JDBC等数据库操作框架使用
                </li>
                <li>
                  了解分布式数据库及Mycat中间件，并正致力于提高分布式数据库能力和对于数据库高并发高可用的知识储备
                </li>
              </ul>
            </div>
          </div>
