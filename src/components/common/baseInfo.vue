<template>
  <header class="content-hd">
    ...
    <section class="contact">
      <ul>
        <li>
          <a href="tel:15680615698" target="_blank">
            <span class="contact-link">15680615698</span>
            <span class="iconfont">
        ...
        <li>
          <a href="mailto:fdrgdf@foxmail.com" target="_blank">
            <span class="contact-link">fdrgdf@foxmail.com</span>
            <span class="iconfont">
              <svg width="16px" height="16px" viewBox="0 0 1024 1024">
                <path
        ...
        <li>
          <a href="https://www.github.com/cresentboy" target="_blank">
            <span class="contact-link">Github | www.github.com/cresentboy</span>
            <span class="iconfont">
              <svg width="16px" height="16px" viewBox="0 0 1024 1024">
                <path
